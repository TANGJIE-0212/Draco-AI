...
export const v3w1d6Data: DayContent = {
  ...
  steps: [
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【概念】Greedy Search (贪婪搜索) 的主要缺点是什么？",
      options: ["计算速度太慢", "生成的内容缺乏多样性，容易重复", "容易产生幻觉"],
      correct: 1
    },
    {
      type: 'fill',
      question: "🐉【识破 AI 魔法】【原理】为了让 AI 像人一样说话，我们需要引入 ___ (Sampling)，即不一定选概率最高的词，而是按概率随机抽取。",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【陷阱】把 Temperature 调高到 1.5 甚至 2.0，最可能发生什么？",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【Debug】用户：「我用 API 写了一个社团自动回信的机器人，但它有时候回复的内容太跳脱，甚至有点不礼貌。」 你的建议是？",
    ...
    {
      type: 'fill',
      question: "🐉【识破 AI 魔法】【动态感知】设置 Top-P=0.9。当模型对下一个词非常确定，最高概率词已占 0.95 时，候选词池的大小约为 ___。",
      parts: ["Top-P=0.9 时，若最高概率词已占 0.95，候选词池大小约为", "___", "（第一个词已超过阈值，立即截断）。"],
      options: ["1 个", "固定 50 个", "取决于词表大小"],
      correct: "1 个"
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【种子】即使参数一样，为什么 OpenAI 有时还是会输出不同的结果？",
