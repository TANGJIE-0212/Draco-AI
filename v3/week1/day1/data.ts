...
export const v3w1d1Data: DayContent = {
  ...
  steps: [
    ...
    {
      type: 'theory',
      content: "🐉 **巨龙解剖档案**\n\n看完视频了吗？让我们通过几个关键的时间节点，来回顾这段激荡的历史。"
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】1. 【起源】『人工智能 (Artificial Intelligence)』这个词最早是在哪里诞生的？",
      options: ["1956年 达特茅斯会议 (Dartmouth Workshop)", "1950年 阿兰·图灵发表《计算机器与智能》时首次提出", "1969年 阿帕网（互联网前身）建立时随之诞生"],
      correct: 0
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】2. 【奠基】阿兰·图灵提出了著名的『图灵测试』。这个测试的核心标准是什么？",
      options: ["机器能否在数学和逻辑推理上超越人类平均水平", "人类裁判在对话中无法分辨对方是机器还是人", "机器能否在国际象棋等复杂棋类游戏中战胜冠军"],
      correct: 1
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】3. 【规则派】早期的 AI（符号主义）主要依靠『专家系统』。它的工作方式更像什么？",
      options: ["像学生一样，从大量例题中归纳出规律", "像医生一样，查阅一本写满『如果…那么…』规则的手册后作出判断", "像人脑神经元一样，通过大量连接自发地形成判断"],
      correct: 1
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】4. 【里程碑】1997年，IBM 的『深蓝 (Deep Blue)』战胜了人类冠军卡斯帕罗夫。它主要依赖的是？",
      options: ["强大的暴力计算能力（每秒穷举 2 亿个棋步）", "深度神经网络，能像人类一样形成棋感直觉", "强化学习，通过自我对弈不断进化棋力"],
      correct: 0
    },
    {
      type: 'fill',
      question: "🐉【识破 AI 魔法】5. 【转折】2016年，AlphaGo 战胜李世石，震惊世界。这标志着 ___ (Machine Learning) 开始超越人类直觉。",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】6. 【数据】为什么 AI 在 2010 年代突然爆发？",
      options: ["AI 算法理论有了根本性突破，完全不依赖数据和算力", "互联网产生了海量数据 + GPU 算力大幅提升，两者缺一不可", "政府出台了大量扶持政策，资金推动了发展"],
      correct: 1
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】7. 【架构】2017年，Google 团队发表了一篇划时代的论文《Attention Is All You Need》，提出了 ___ 架构。ChatGPT 正是基于此架构构建的。",
      options: ["RNN (循环神经网络，按顺序一个字一个字读)", "Transformer（能一眼看完整篇文章）", "CNN (卷积神经网络，常用于看图)"],
      correct: 1
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】8. 【现象】ChatGPT 的出现标志着 AI 从「分析型（如人脸识别）」转向了「___ 型」。",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】10. 【趋势】摩尔定律预言了芯片性能的翻倍，而 AI 模型的参数量增长速度？",
