...
export const v3w1d5Data: DayContent = {
  ...
  steps: [
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【概念辨析】关于「训练数据」和「Context」，以下说法正确的是？",
      options: ["我们在对话框里发给 AI 的内容，会实时更新它的训练数据，让它变聪明", "Context 是临时的，一刷新网页或开启新对话，之前的 Context 就消失了", "训练数据就是 Context，两者是一回事"],
      correct: 1
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【计算直觉】如果把 Context Window 从 4k 提升到 8k，理论上 Attention 矩阵的计算量会增加多少倍？",
      options: ["2倍", "4倍 (平方级增长)", "8倍"],
      correct: 1
    },
    {
      type: 'fill',
      question: "🐉【识破 AI 魔法】【术语】当对话长度超过了模型限制，最早的信息会被强制丢弃，这种机制通常被称为 ___ (Sliding Window)。",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【选型】什么情况下 **必须** 使用 RAG，而不是仅靠模型自带的知识？",
      options: ["询问 2008 年北京奥运会的时间", "询问今天的龙学院内部资料库的实时库存记录（私有且实时变化）", "翻译一段英文"],
      correct: 1
    },
    {
      type: 'fill',
      question: "🐉【识破 AI 魔法】【原理】RAG 技术本质上是用",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【陷阱】有了 100万 Token 的超大窗口模型（如 Gemini 1.5 Pro），RAG 就会彻底消亡吗？",
      options: ["会，RAG 没有任何存在的意义了", "不会，RAG 在成本、速度和私有权限控制上仍有优势", "不会，但只有处理超过 100 万 Token 的文档时 RAG 才有必要"],
      correct: 1
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【计算】假设 1000 Token = $0.01。每次都把整本《红楼梦》（约 80 万汉字，按汉字≈1.5 Token 估算约 120 万 Token）丢给 AI 提问，和用 RAG 每次只检索 2000 Token 相比，成本差异大约是？",
      options: ["成本差不多", "前者成本是后者的约 600 倍", "RAG 更贵，因为要维护数据库"],
      correct: 1
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【Debug】使用了 RAG 后，AI 回答：「根据提供的文档，我不知道答案。」 这说明？",
      options: ["检索阶段出了问题，导致返回了错误的文档片段", "这是正常的，说明检索到的文档里确实没有相关信息，AI 诚实地回答了", "AI 的生成能力下降了，应该换回不用 RAG 的方式"],
      correct: 1
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【幻觉】相比于直接问模型，使用 RAG 通常能 ___ 幻觉（Hallucination）。",
