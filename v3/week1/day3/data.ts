...
export const v3w1d3Data: DayContent = {
  ...
  steps: [
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】🧠 **思维实验**：AI 看到 'Strawberry' (草莓) 时，它实际接收到的输入更像以下哪种形式？",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】💼 **龙学院算力管理员**：假设 API 价格是 $0.002 / 1k Tokens。你要处理一篇 5000 个单词的英文论文，大概需要支付多少钱？",
    ...
    { 
      type: 'theory', 
      content: "🐉 **巨龙解剖档案**\n\n📐 **深入原理：余弦相似度 (Cosine Similarity)**\n\nAI 怎么知道「猫」和「狗」很像？它计算两个向量在空间中的**夹角**。\n\n- 夹角接近 0 度（方向一致）：意思极度相似。\n- 夹角 90 度（垂直）：毫无关系。\n- 夹角 180 度（相反）：意思相反。" 
    },
    // 活学活用 4：空间直觉
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】🧭 **导航员测试**：在 Embedding 星图中，'苹果' 这个词的坐标，应该离下面哪个词最近？",
    ...
    {
      type: 'fill',
      question: "🐉【识破 AI 魔法】🧠 **语境感知**：在 'The apple fell from the tree' 这句话中，因为上下文是\"树\"和\"掉落\"，'apple' 的向量会**远离** ___ 相关的语义区域，而靠近水果/植物区域。",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】⚗️ **炼金术士**：请推测这个向量公式的结果：\nVector(巴黎) - Vector(法国) + Vector(日本) ≈ ？",
      options: ["寿司", "东京", "亚洲"],
      correct: 1
    },
    // 活学活用 7：RAG (检索增强) 预热
