...
export const v3w1d7Data: DayContent = {
  ...
  steps: [
    ...
    },
    {
      ...
      pairs: [
        { left: "龙学院秘藏档案库：数据绝对不能出内网", right: "本地部署开源模型 (Self-hosted)" },
        { left: "独立创作社成员：快速验证创意，没钱买显卡", right: "云端 API 按量付费（如 OpenAI / Anthropic）" },
        { left: "龙族研究员：需要研究模型底层架构", right: "下载开源模型权重自行研究" },
        { left: "学院问答台：需要极高的稳定性且不想招运维", right: "签带 SLA 保障的专业级闭源 API 合约" }
      ]
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】【误区】开源模型意味着完全免费吗？",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】1. 【原理】AI 本质上是在计算什么？ P(wt | w0...wt-1)",
      options: ["计算这句话的情感得分", "给定前面的词，计算下一个词出现的条件概率", "计算这句话的真理性"],
      correct: 1
    },
    {
      type: 'fill',
      question: "🐉【识破 AI 魔法】2. 【核心】Transformer 区别于 RNN 的最大优势是它可以 ___ (Parallel) 计算，并且捕捉长距离依赖。",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】3. 【Embedding】为什么 '国王 - 男人 + 女人' 能算出 '女王'？",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】5. 【Context】当 Output Token 达到上限时，通常会发生什么？",
      options: ["AI 会自动压缩并总结之前的对话，无缝续写", "句子会突然中断 (Truncated)", "模型会删掉前面的对话腾出空间"],
      correct: 1
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】6. 【RAG】为什么有了 RAG 还需要 Prompt Engineering？",
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】7. 【Temperature】你在做一个自动写代码的插件，为了保证代码能运行（不瞎编函数名），Temperature 应设为？",
      options: ["0.0 或 0.1（贪心或接近贪心，每次选最高概率词，代码最确定性强）", "0.9（发散创意，让函数名更有创造力）", "2.0（完全随机，代码风格百变）"],
      correct: 0
    },
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】8. 【Prompt】「Let's think step by step」是为了激活模型的什么能力？",
      options: [
    ...
    {
      type: 'quiz',
      question: "🐉【识破 AI 魔法】10. 【终极应用】你要开发一个「法条查阅助手」。\n要求：严谨、引用法条准确、不编造内容。\n最佳技术栈组合是？",
      options: ["Temp=1.0 + 纯 Prompt（让 AI 自由发挥）", "Temp=0.1 + RAG（挂载法条库）+ System Role（'你是严谨的法条研究员'）", "Temp=0.5 + 不给任何约束（模型自己判断）"],
      correct: 1
    },
    {
      type: 'match',
